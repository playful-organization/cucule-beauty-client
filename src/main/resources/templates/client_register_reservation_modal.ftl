...
<form action="/client/schedule/register?date=${clientScheduleModel.currentDateParam}" method="post">
    <div class="modal fade" id="registerReservation" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span>×</span></button>
                    <h4 class="modal-title">予約登録</h4>
                </div>
            <#include "/error_message.ftl">
                <div class="modal-body">
                                    ...
                                    <div class='col-sm-6'>
                                        <div class="form-group">
                                            <div class="input-group date onlickDate">
                                                <input type="text" name="raitenDate" id="raitenDate"
                        ...
                        <tr>
                            <td>
                                ...
                                &nbsp終了時間&nbsp;:&nbsp;<input type="text" name="endTime" class="none Width40"
                                                             id="endTime" readonly/>
                                &nbsp施術時間&nbsp;:&nbsp;
                                <select name="needTime" id="needTime">
                                    <!-- TODO DBから取得したい -->
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <th class="warning">氏名(カナ)<span id="required">※</span></th>
                            <td>
                                <div class="form-group form-inline">
                                    <input type="text" name="lastNameKana" class="form-control" id="lastNameKana"
                                           placeholder="シ">
                                    <input type="text" name="firstNameKana" class="form-control" id="firstNameKana"
                                           placeholder="メイ">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-group form-inline">
                                    <input type="text" name="lastNameKanji" class="form-control" id="lastNameKanji"
                                           placeholder="氏">
                                    <input type="text" name="firstNameKanji" class="form-control" id="firstNameKanji"
                                           placeholder="名">
                                </div>
                            </td>
                        </tr>
